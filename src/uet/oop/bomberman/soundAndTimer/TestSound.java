...
public class TestSound {
	...
	public TestSound() throws UnsupportedAudioFileException, IOException, LineUnavailableException {
	...
	public static void main(String[] args) {
		try {
			filePath = "res\\sounds\\gameOver.wav";
			TestSound audioPlayer = new TestSound();
